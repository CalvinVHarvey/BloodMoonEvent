...
import me.NorthAlaska.BloodMoonEvent.events.BloodMoonEvent;
import me.NorthAlaska.BloodMoonEvent.events.IsNightTime;
import me.NorthAlaska.BloodMoonEvent.events.NightEvent;
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) 
	{
		...
		else if(args[0].equalsIgnoreCase("reload"))
		{
			if (p.hasPermission("Bloodmoon.reload"))
			{
				...
				p.sendMessage(Utils.chat("&aSuccessfully Reloaded Config"));
			}
			else
			{
				p.sendMessage(Utils.chat("&cInsufficient Permissions"));
